...
$BB87_9:                                #   in Loop: Header=BB87_7 Depth=1
	...
	j	$BB87_10
	nop
$BB87_10:                               #   in Loop: Header=BB87_7 Depth=1
	lw	$1, 32($fp)
	srl	$2, $1, 31
	addu	$1, $1, $2
	sra	$1, $1, 1
...
$BB87_12:
	j	$BB87_14
	nop
$BB87_13:                               #   in Loop: Header=BB87_7 Depth=1
	lw	$5, 28($fp)
	move	$4, $5
	jal	__mulsf3
	nop
...
$BB88_8:
	...
	j	$BB88_9
	nop
$BB88_9:                                # =>This Inner Loop Header: Depth=1
	lw	$1, 52($fp)
	srl	$2, $1, 31
	addu	$2, $1, $2
	addiu	$3, $zero, -2
...
# %bb.10:                               #   in Loop: Header=BB88_9 Depth=1
	j	$BB88_11
	nop
$BB88_11:                               #   in Loop: Header=BB88_9 Depth=1
	lw	$6, 40($fp)
	lw	$7, 44($fp)
	lw	$4, 56($fp)
	lw	$5, 60($fp)
	...
	j	$BB88_12
	nop
$BB88_12:                               #   in Loop: Header=BB88_9 Depth=1
	lw	$1, 52($fp)
	srl	$2, $1, 31
	addu	$1, $1, $2
	sra	$1, $1, 1
...
$BB88_14:
	j	$BB88_16
	nop
$BB88_15:                               #   in Loop: Header=BB88_9 Depth=1
	lw	$6, 40($fp)
	lw	$7, 44($fp)
	move	$4, $6
	move	$5, $7
...
$BB89_8:
	...
	j	$BB89_9
	nop
$BB89_9:                                # =>This Inner Loop Header: Depth=1
	lw	$1, 52($fp)
	srl	$2, $1, 31
	addu	$2, $1, $2
	addiu	$3, $zero, -2
...
# %bb.10:                               #   in Loop: Header=BB89_9 Depth=1
	j	$BB89_11
	nop
$BB89_11:                               #   in Loop: Header=BB89_9 Depth=1
	lw	$6, 40($fp)
	lw	$7, 44($fp)
	lw	$4, 56($fp)
	lw	$5, 60($fp)
	...
	j	$BB89_12
	nop
$BB89_12:                               #   in Loop: Header=BB89_9 Depth=1
	lw	$1, 52($fp)
	srl	$2, $1, 31
	addu	$1, $1, $2
	sra	$1, $1, 1
...
$BB89_14:
	j	$BB89_16
	nop
$BB89_15:                               #   in Loop: Header=BB89_9 Depth=1
	lw	$6, 40($fp)
	lw	$7, 44($fp)
	move	$4, $6
	move	$5, $7

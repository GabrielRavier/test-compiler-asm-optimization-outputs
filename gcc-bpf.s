...
.L121:
	r0 = *(u32 *) (r10+-4)
	if w0 <= 8231 goto .L124
	r0 = *(u32 *) (r10+-4)
	w0 += -8234
	r0 = r0
	if w0 <= 47061 goto .L124
	r0 = *(u32 *) (r10+-4)
	w0 += -57344
	r0 = r0
	if w0 > 8184 goto .L125
.L124:
	r0 = 1
	exit
.L125:
	...
	w0 += -65532
	r0 = r0
	if w0 > 1048579 goto .L126
	r0 = *(u32 *) (r10+-4)
	w0 &= 65534
	r0 <<= 32
	r0 s>>= 32
	if w0 != 65534 goto .L127
.L126:
	r0 = 0
	exit
.L127:

...
frexp:
	*(u64 *) (r10+-8) = r2
	...
	r2 = 0x0000000000000000 ll
	call	__ltdf2
	if r7 s>= r0 goto .L1794
	r2 = 0x3ff0000000000000 ll
	r1 = r6
	call	__gedf2
	if r0 s< 0 goto .L1795
	*(u64 *) (r10+-16) = r7
.L1763:
	r8 = 0
	r7 = 0x3fe0000000000000 ll
...
__mspabi_cmpf:
	...
	call	__ltsf2
	r3 = 0
	if r3 s>= r0 goto .L2355
	r8 = 1
	r2 = r7
	r1 = r6
	call	__gtsf2
	if r0 s<= 0 goto .L2356
	r0 = r8
	r0 &= 1
	exit
.L2356:
...
__mspabi_cmpd:
	...
	call	__ltdf2
	r3 = 0
	if r3 s>= r0 goto .L2360
	r8 = 1
	r2 = r7
	r1 = r6
	call	__gtdf2
	if r0 s<= 0 goto .L2361
	r0 = r8
	r0 &= 1
	exit
.L2361:
...
__cmpdi2:
	...
	r3 s>>= 32
	r0 s>>= 32
	if r0 s>= r3 goto .L2656
	if r3 s> r0 goto .L2657
	r1 = r1;r1 &= 0xffffffff
	r2 = r2;r2 &= 0xffffffff
	if r2 >= r1 goto .L2656
	if r1 > r2 goto .L2657
...
__aeabi_lcmp:
	...
	r3 s>>= 32
	r0 s>>= 32
	if r0 s>= r3 goto .L2663
	if r3 s> r0 goto .L2662
	r1 = r1;r1 &= 0xffffffff
	r2 = r2;r2 &= 0xffffffff
	if r2 >= r1 goto .L2663
	r0 = 1
...
__cmpti2:
	if r4 s>= r2 goto .L2669
	if r2 s> r4 goto .L2670
	if r3 >= r1 goto .L2669
	if r1 > r3 goto .L2670
	r0 = 1
	exit

...
__modsi3:
	r0 = r2
	if r1 s< 0 goto .L1870
	if r2 s< 0 goto .L1871
.L1868:
	r3 = 1
	call	__udivmodsi4
	r0 = r0;r0 &= 0xffffffff
...
__cmpdi2:
	...
	r0 = r2
	r0 s>>= 32
	if r0 s> r3 goto .L1993
	if r3 s>= r0 goto .L1994
	r1 = r1;r1 &= 0xffffffff
	r2 = r2;r2 &= 0xffffffff
	if r2 >= r1 goto .L1995
	if r1 > r2 goto .L1996
...
__cmpti2:
	if r4 s> r2 goto .L2000
	if r2 s>= r4 goto .L2001
	if r3 >= r1 goto .L2002
	if r1 > r3 goto .L2003
	r0 = 1
	exit

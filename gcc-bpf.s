...
gl_isinfl:
	...
	r2 = 0xffefffffffffffff ll
	call	__ltdf2
	if r0 s<= 0 goto .L1067
	r7 = 1
	r2 = 0x7fefffffffffffff ll
	r1 = r6
	call	__gtdf2
	if r0 s<= 0 goto .L1068
.L1066:
	r0 = r7
	r0 &= 1
	exit
...
__cmpdi2:
	...
	r0 = r2
	r0 s>>= 32
	if r0 s>= r3 goto .L2022
	if r3 s> r0 goto .L2023
	r1 = r1;r1 &= 0xffffffff
	r2 = r2;r2 &= 0xffffffff
	if r2 >= r1 goto .L2022
	if r1 > r2 goto .L2023
...
__cmpti2:
	if r4 s>= r2 goto .L2029
	if r2 s> r4 goto .L2030
	if r3 >= r1 goto .L2029
	if r1 > r3 goto .L2030
	r0 = 1
	exit

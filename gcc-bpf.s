...
__cmpdi2:
	...
	r0 = r2
	r0 s>>= 32
	if r0 s> r3 goto .L1985
	if r3 s>= r0 goto .L1986
	r1 = r1;r1 &= 0xffffffff
	r2 = r2;r2 &= 0xffffffff
	if r2 >= r1 goto .L1987
	if r1 > r2 goto .L1988
...
__cmpti2:
	if r4 s> r2 goto .L1992
	if r2 s>= r4 goto .L1993
	if r3 >= r1 goto .L1994
	if r1 > r3 goto .L1995
	r0 = 1
	exit

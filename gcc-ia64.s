...
__cmovd:
	...
	nop 0
	nop 0
	(p7) br.cond.dptk .L854
	;;
	.mib
	nop 0
	cmp.ltu p6, p7 = r17, r32
	(p7) br.cond.dptk .L865
	;;
.L854:
	.mii
	cmp4.ne p6, p7 = 0, r19
...
.L1020:
	...
	(p6) br.cond.dptk .L1020
	.mib
	nop 0
	(p9) mov r8 = r0
	(p9) br.cond.dpnt .L1022
	;;
.L1021:
	.mmi
	mov r8 = r0
...
.L1038:
	...
	nop 0
	(p9) cmp4.ne.and.orcm p6, p7 = 0, r0
	(p6) br.cond.dptk .L1038
	.mib
	nop 0
	nop 0
	(p9) br.cond.dpnt .L1040
	;;
	.align 32
.L1054:
	.mmi

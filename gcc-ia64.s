...
wmemmove:
	...
	mov r2 = ar.lc
	.body
	(p7) br.cond.dpnt .L541
	;;
	.mib
	cmp.gtu p6, p7 = r16, r17
	nop 0
	(p7) br.cond.dptk .L549
	;;
	.mib
	shladd r14 = r14, 2, r0
	cmp.eq p6, p7 = 0, r34
...
.L713:
	...
	cmp4.ne p6, p7 = 0, r14
	nop 0
	(p7) br.cond.dpnt .L718
	;;
	.mib
	nop 0
	cmp4.eq p6, p7 = r16, r14
	(p7) br.cond.dptk .L713
	.mib
	nop 0
	nop 0
	br.ret.sptk.many b0
...
__cmovd:
	...
	nop 0
	nop 0
	(p7) br.cond.dptk .L866
	;;
	.mib
	nop 0
	cmp.ltu p6, p7 = r17, r32
	(p7) br.cond.dptk .L877
	;;
.L866:
	.mii
	cmp4.ne p6, p7 = 0, r19
...
__cmovw:
	...
	nop 0
	nop 0
	(p7) br.cond.dptk .L897
	;;
	.mib
	nop 0
	cmp.ltu p6, p7 = r17, r32
	(p7) br.cond.dptk .L908
	;;
.L897:
	.mii
	cmp4.ne p6, p7 = 0, r19
...
.L1032:
	...
	(p6) br.cond.dptk .L1032
	.mib
	nop 0
	(p9) mov r8 = r0
	(p9) br.cond.dpnt .L1034
	;;
.L1033:
	.mmi
	mov r8 = r0

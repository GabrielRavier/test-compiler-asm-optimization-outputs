...
.L968:
	...
	.mbb
	cmp4.ne p6, p7 = 0, r16
	(p7) br.cond.dpnt .L970
	br.cloop.sptk.few .L968
.L967:
	.mmi
	st1 [r14] = r0
	nop 0
...
.L1026:
	...
	nop 0
	(p6) br.cond.dpnt .L1016
	;;
	.mib
	nop 0
	cmp4.ne p6, p7 = 0, r14
	(p6) br.cond.dptk .L1017
	.mib
	nop 0
	mov r8 = r0
	br.ret.sptk.many b0
...
.L1299:
	...
	adds r17 = -1, r34
	cmp4.ne p6, p7 = 0, r34
	(p7) br.cond.dpnt .L1237
	;;
	.mib
	addp4 r18 = r17, r0
	cmp4.geu p6, p7 = 8, r17
	(p6) br.cond.dpnt .L1250
	;;
	.mmi
	adds r14 = -7, r18
	adds r19 = -1, r18
...
__cmovw:
	...
	nop 0
	cmp.ltu p6, p7 = r14, r32
	(p7) br.cond.dptk .L1387
	;;
.L1311:
	.mib
	nop 0
	cmp4.ne p6, p7 = 0, r18
	(p7) br.cond.dpnt .L1388
	.mmi
	nop 0
	adds r14 = -1, r18
	nop 0
...
.L1523:
	...
	(p6) br.cond.dptk .L1523
	.mib
	nop 0
	(p9) mov r8 = r0
	(p9) br.cond.dpnt .L1525
	;;
.L1524:
	.mmi
	mov r8 = r0
...
.L1541:
	...
	nop 0
	(p9) cmp4.ne.and.orcm p6, p7 = 0, r0
	(p6) br.cond.dptk .L1541
	.mib
	nop 0
	nop 0
	(p9) br.cond.dpnt .L1543
	;;
	.align 32
.L1558:
	.mmi

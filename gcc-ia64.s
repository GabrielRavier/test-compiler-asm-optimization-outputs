...
wcschr:
	...
	nop 0
	cmp4.ne p6, p7 = 0, r14
	(p7) br.cond.dpnt .L616
	.align 32
.L613:
	.mib
	cmp4.ne p8, p9 = r14, r33
	nop 0
	(p9) br.cond.dpnt .L622
	;;
	.mmi
	adds r32 = 4, r32
	;;
...
.L626:
	...
	.bbb
	nop 0
	(p6) br.cond.dpnt .L624
	(p8) br.cond.dptk .L626
.L624:
	.mmi
	addl r8 = -1, r0
	nop 0
...
.L673:
	...
	(p9) br.cond.dpnt .L686
	br.cloop.sptk.few .L673
.L682:
	.mmi
	mov r8 = r0
	nop 0
...
wmemmove:
	...
	mov r17 = r9
	mov r10 = r9
	(p8) br.cond.dptk .L696
	;;
	.bbb
	(p11) br.cond.dpnt .L709
	(p14) br.cond.dpnt .L700
	(p13) br.cond.dpnt .L700
	;;
	.mii
	nop 0
	mov ar.lc = r9
...
.L703:
	...
	st8 [r15] = r16
	adds r15 = 8, r15
	br.cloop.sptk.few .L703
	.mib
	and r14 = -2, r34
	tbit.z p8, p9 = r34, 0
	(p8) br.cond.dpnt .L709
	;;
.L730:
	.mmi
	shladd r21 = r14, 2, r0
...
.L696:
	...
	(p10) br.cond.dpnt .L709
	;;
	.mib
	nop 0
	nop 0
	(p13) br.cond.dptk .L725
	.mmi
	ld4 r15 = [r33]
	adds r33 = -4, r33
	mov ar.lc = r16
...
.L735:
	...
	st4 [r23] = r33
	nop 0
	(p8) br.cond.dpnt .L734
	;;
	.mib
	st4 [r24] = r33
	nop 0
	(p10) br.cond.dpnt .L734
	;;
	.mmi
	st4 [r25] = r33
	(p13) st4 [r21] = r33
...
bcopy:
	...
	add r33 = r33, r28
	adds r32 = -8, r18
	(p32) br.cond.dpnt .L765
	;;
	.mib
	nop 0
	nop 0
	(p34) br.cond.dpnt .L768
	;;
	.mii
	nop 0
	shr.u r25 = r32, 3
	...
	nop 0
	(p40) br.cond.dpnt .L768
	;;
	.mib
	nop 0
	cmp.lt p42, p43 = 2, r8
	(p43) br.cond.dptk .L836
	.mmi
	ld8 r15 = [r14]
	adds r14 = -8, r14
	mov ar.lc = r20
...
.L766:
	...
	nop 0
	(p14) br.cond.dpnt .L773
	;;
	.mib
	adds r18 = -1, r11
	cmp.lt p16, p17 = 2, r11
	(p17) br.cond.dptk .L839
	;;
	.mmi
	ld8 r15 = [r32]
	adds r14 = 8, r32
...
ldexpf:
	...
	.mbb
	nop 0
	(p10) br.cond.dptk .L906
	(p12) br.cond.dptk .L908
	.align 32
.L909:
	.mfi
	nop 0
...
ldexp:
	...
	.mbb
	nop 0
	(p10) br.cond.dptk .L918
	(p12) br.cond.dptk .L920
	.align 32
.L921:
	.mfi
	nop 0
...
memxor:
	...
	.mbb
	nop 0
	(p6) br.cond.dpnt .L942
	(p2) br.cond.dpnt .L981
	;;
	.mib
	nop 0
	shr.u r10 = r17, 3
	(p4) br.cond.dpnt .L981
	;;
	.mii
	nop 0
	mov ar.lc = r10
...
.L998:
	...
	(p13) br.cond.dpnt .L1000
	br.cloop.sptk.few .L998
.L997:
	.mmi
	st1 [r17] = r0
	nop 0
...
.L1025:
	...
	.bbb
	nop 0
	(p9) br.cond.dpnt .L1032
	(p13) br.cond.dptk .L1025
	.mib
	nop 0
	nop 0
	br.ret.sptk.many b0
...
.L1057:
	...
	.bbb
	nop 0
	(p12) br.cond.dpnt .L1047
	(p14) br.cond.dptk .L1048
	.mib
	nop 0
	mov r8 = r0
	br.ret.sptk.many b0
...
memmem:
	...
	.mbb
	nop 0
	(p6) br.cond.dpnt .L1077
	(p10) br.cond.dpnt .L1088
	;;
	.mib
	nop 0
	cmp.ltu p12, p13 = r27, r32
	(p12) br.cond.dpnt .L1088
	;;
	.mmi
	chk.s r19, .L1105
	nop 0
...
.L1102:
	...
	ld1.s r17 = [r11]
	ld1.s r10 = [r15]
	(p7) br.cond.dpnt .L1096
	;;
	.mib
	mov r25 = r18
	cmp.gtu p10, p11 = r18, r27
	br.cloop.sptk.few .L1080
	;;
	.mib
	nop 0
	mov ar.lc = r2
...
.L1140:
	...
	.mbb
	nop 0
	(p11) br.cond.dptk .L1120
	(p12) br.cond.dpnt .L1129
.L1120:
	.mib
	st4 [r33] = r0
	nop 0
...
udivmodsi4:
	...
	addl r14 = 1, r0
	nop 0
	cmp4.geu p8, p9 = r32, r33
	.mmb
	cmp.ne p14, p15 = 0, r34
	cmp4.gtu p6, p7 = r32, r33
	(p7) br.cond.dpnt .L1175
	.mmi
	cmp4.le p10, p11 = r0, r33
	nop 0
	nop 0
	.align 32
.L1150:
	...
	;;
	.mmi
	cmp4.ltu p12, p13 = r33, r32
	cmp4.ne p14, p15 = 0, r14
	cmp4.le p10, p11 = r0, r33
	;;
	.mmi
	(p14) addl r16 = 1, r0
...
__cmovh:
	...
	(p37) mov r24 = r0
	cmp.lt p44, p45 = 2, r8
	(p7) br.cond.dptk .L1375
	;;
	.mib
	nop 0
	nop 0
	(p3) br.cond.dptk .L1350
.L1375:
	...
	.bbb
	nop 0
	(p35) br.cond.dpnt .L1291
	(p40) br.cond.dpnt .L1361
	;;
	.mbb
	cmp4.eq p42, p43 = 0, r21
	(p42) br.cond.dpnt .L1361
	(p45) br.cond.dptk .L1342
	.mmi
	ld8 r16 = [r14]
	adds r14 = 8, r14
	mov ar.lc = r19
...
.L1350:
	...
	nop 0
	(p14) br.cond.dpnt .L1301
	;;
	.mib
	adds r21 = -1, r30
	cmp.lt p16, p17 = 2, r30
	(p17) br.cond.dptk .L1345
	;;
	.mmi
	ld8 r16 = [r14]
	adds r14 = -8, r14
...
.L1486:
	...
	nop 0
	(p44) br.cond.dpnt .L1488
	;;
	.mib
	adds r19 = -1, r31
	cmp.lt p46, p47 = 2, r31
	(p47) br.cond.dptk .L1445
	;;
	.mmi
	ld8 r17 = [r14]
	adds r14 = 8, r14
...
.L1387:
	...
	nop 0
	(p60) br.cond.dpnt .L1379
	;;
	.mib
	adds r19 = -1, r9
	cmp.lt p62, p63 = 2, r9
	(p63) br.cond.dptk .L1448
	;;
	.mmi
	ld8 r17 = [r14]
	adds r14 = 8, r14
...
.L1466:
	...
	nop 0
	(p14) br.cond.dpnt .L1392
	;;
	.mib
	adds r21 = -1, r29
	cmp.lt p16, p17 = 2, r29
	(p17) br.cond.dptk .L1451
	;;
	.mmi
	ld8 r16 = [r14]
	adds r14 = -8, r14
...
__clzhi2:
	...
	(p12) addl r8 = 2, r0
	nop 0
	(p12) br.cond.dpnt .L1501
	;;
	.mib
	cmp4.ne p12, p13 = 0, r20
	(p14) addl r8 = 3, r0
	(p14) br.cond.dpnt .L1501
	;;
	.mib
...
__mulsi3_lm32:
	...
	.bbb
	nop 0
	(p6) br.cond.dpnt .L1564
	(p8) br.cond.dpnt .L1564
	.mii
	nop 0
	extr r14 = r33, 0, 1
	nop 0
...
__divsi3:
	...
	mov r2 = r33
	.mmb
	cmp4.leu p12, p13 = r33, r32
	cmp4.ltu p10, p11 = r33, r32
	(p11) br.cond.dpnt .L1647
	;;
	.align 32
.L1624:
	.mib
	cmp4.le p14, p15 = r0, r2
	nop 0
	(p15) br.cond.dpnt .L1626
	;;
	.mmi
	shladd r2 = r2, 1, r0
	nop 0
	...
	(p6) br.cond.dptk .L1624
	.mib
	nop 0
	(p9) mov r8 = r0
	(p9) br.cond.dpnt .L1627
	;;
.L1626:
	.mmb
	nop 0
...
__modsi3:
	...
	mov r8 = r32
	mov r14 = r33
	cmp4.gtu p12, p13 = r33, r32
	.mmb
	cmp4.eq p14, p15 = 0, r17
	cmp4.ltu p10, p11 = r33, r32
	(p11) br.cond.dpnt .L1673
	;;
	.align 32
.L1650:
	.mib
	cmp4.le p14, p15 = r0, r14
	nop 0
	(p15) br.cond.dpnt .L1674
	;;
	.mmi
	shladd r14 = r14, 1, r0
	nop 0
	...
	nop 0
	(p9) cmp4.ne.and.orcm p6, p7 = 0, r0
	(p6) br.cond.dptk .L1650
	.mib
	nop 0
	nop 0
	(p9) br.cond.dpnt .L1653
	.align 32
.L1674:
	.mmi
	sub r16 = r8, r14
...
__udivmodhi4:
	...
	.mmb
	(p8) addl r19 = 1, r0
	cmp4.gtu p6, p7 = r24, r33
	(p7) br.cond.dpnt .L1760
	;;
	.mii
	nop 0
	sxt2 r16 = r17
	...
	.mib
	nop 0
	cmp4.le p10, p11 = r0, r16
	(p11) br.cond.dpnt .L1761
	.mmi
	nop 0
	cmp4.ltu p8, p9 = r10, r8
	cmp4.ne p6, p7 = 0, r9
	.mmi
	nop 0
	shladd r15 = r10, 1, r0
...
.L1681:
	...
	nop 0
	cmp4.le p10, p11 = r0, r16
	(p10) br.cond.dptk .L1681
.L1761:
	.mmb
	sub r8 = r24, r17
	cmp4.ltu p12, p13 = r24, r17
	nop 0
	.mmi
	mov r19 = r0
	nop 0
	...
	nop 0
	mov r20 = r19
	(p15) br.cond.dpnt .L1683
	;;
.L1751:
	.mmi
	sub r32 = r8, r22
	cmp4.ltu p6, p7 = r8, r22
	extr.u r3 = r18, 2, 14
	;;
	.mii
	nop 0
	...
	mov r8 = r14
	mov r19 = r15
	(p8) br.cond.dpnt .L1683
	.mmi
	sub r9 = r14, r16
	cmp4.gtu p10, p11 = r16, r14
	extr.u r21 = r18, 3, 13
	;;
	.mii
	nop 0
	...
	mov r8 = r11
	mov r19 = r20
	(p12) br.cond.dpnt .L1683
	;;
	.mmi
	sub r8 = r11, r22
	cmp4.gtu p14, p15 = r22, r11
	extr.u r26 = r18, 4, 12
	;;
	.mii
	nop 0
	...
	mov r8 = r24
	mov r19 = r28
	(p6) br.cond.dpnt .L1683
	.mmi
	sub r29 = r24, r27
	cmp4.gtu p8, p9 = r27, r24
	extr.u r33 = r18, 5, 11
	;;
	.mii
	nop 0
	...
	mov r8 = r31
	mov r19 = r2
	(p10) br.cond.dpnt .L1683
	.mmi
	sub r3 = r31, r14
	cmp4.gtu p12, p13 = r14, r31
	extr.u r10 = r18, 6, 10
	;;
	.mii
	nop 0
	...
	mov r8 = r9
	mov r19 = r21
	(p14) br.cond.dpnt .L1683
	;;
	.mmi
	sub r19 = r9, r11
	cmp4.gtu p6, p7 = r11, r9
	extr.u r25 = r18, 7, 9
	;;
	.mii
	nop 0
	...
	.mmi
	sub r28 = r24, r20
	cmp4.gtu p8, p9 = r20, r24
	tbit.z p10, p11 = r18, 15
	;;
	.mii
	nop 0
	extr.u r17 = r17, 15, 1
...
__udivmodsi4_libgcc:
	...
	addl r14 = 1, r0
	nop 0
	cmp.geu p8, p9 = r32, r33
	.mmb
	cmp4.ne p14, p15 = 0, r34
	cmp.gtu p6, p7 = r32, r33
	(p7) br.cond.dpnt .L1788
	.mii
	nop 0
	tbit.z p10, p11 = r33, 31
	nop 0
	.align 32
.L1763:
	.pred.rel.mutex p10, p11
	...
	;;
	.mmi
	cmp.ltu p12, p13 = r33, r32
	cmp.ne p14, p15 = 0, r14
	tbit.z p10, p11 = r33, 31
	;;
	.mmi
	(p14) addl r16 = 1, r0
...
__ashldi3:
	...
	.bbb
	nop 0
	(p7) br.cond.dptk .L1791
	(p8) br.cond.dpnt .L1789
	;;
	.mii
	nop 0
	shl r11 = r9, 32
...
__ashrdi3:
	...
	.bbb
	nop 0
	(p7) br.cond.dptk .L1805
	(p8) br.cond.dpnt .L1803
	;;
	.mii
	nop 0
	shr.u r8 = r14, r18
...
__cmpdi2:
	...
	(p6) br.cond.dpnt .L1833
	;;
	.mib
	(p12) addl r8 = 2, r0
	nop 0
	(p12) br.cond.dpnt .L1829
	;;
	.mmi
	nop 0
	(p10) addl r8 = 2, r0
...
__aeabi_lcmp:
	...
	cmp4.lt p12, p13 = r14, r15
	cmp4.gt p6, p7 = r14, r15
	(p6) br.cond.dpnt .L1841
	;;
	.mib
	(p12) addl r8 = 1, r0
	nop 0
	(p12) br.cond.dpnt .L1837
	;;
	.mmi
	nop 0
	(p10) addl r8 = 1, r0
...
__cmpti2:
	...
	(p6) br.cond.dpnt .L1848
	;;
	.mib
	(p10) addl r8 = 2, r0
	nop 0
	(p10) br.cond.dpnt .L1844
	;;
	.mmi
	nop 0
	(p8) addl r8 = 2, r0
...
__ucmpdi2:
	...
	(p6) br.cond.dpnt .L1927
	;;
	.mib
	(p12) addl r8 = 2, r0
	nop 0
	(p12) br.cond.dpnt .L1923
	;;
	.mmi
	nop 0
	(p10) addl r8 = 2, r0
...
__aeabi_ulcmp:
	...
	cmp4.ltu p12, p13 = r14, r15
	cmp4.gtu p6, p7 = r14, r15
	(p6) br.cond.dpnt .L1935
	;;
	.mib
	(p12) addl r8 = 1, r0
	nop 0
	(p12) br.cond.dpnt .L1931
	;;
	.mmi
	nop 0
	(p10) addl r8 = 1, r0
...
__ucmpti2:
	...
	cmp.gtu p12, p13 = r34, r32
	(p6) br.cond.dpnt .L1942
	;;
	.mib
	(p10) addl r8 = 2, r0
	nop 0
	(p10) br.cond.dpnt .L1938
	;;
	.mmi
	nop 0
	(p8) addl r8 = 2, r0

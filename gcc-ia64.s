...
wmemmove:
	...
	adds r14 = -1, r34
	mov r15 = r32
	(p7) br.cond.dpnt .L480
	;;
	.mib
	nop 0
	cmp.gtu p6, p7 = r16, r17
	(p7) br.cond.dptk .L488
	;;
	.mib
	shladd r14 = r14, 2, r0
	cmp.eq p6, p7 = 0, r34
	(p6) br.cond.dpnt .L480
	;;
	.mii
	nop 0
	shr.u r15 = r14, 2
...
__cmovh:
	...
	nop 0
	cmp.ltu p6, p7 = r17, r32
	(p7) br.cond.dptk .L806
	;;
.L792:
	.mib
	shladd r16 = r16, 1, r0
	cmp4.eq p6, p7 = 0, r18
	(p6) br.cond.dpnt .L795
	;;
	.mii
	adds r16 = -2, r16
	nop 0
...
.L943:
	...
	(p6) br.cond.dptk .L943
	.mib
	nop 0
	nop 0
	(p9) br.cond.dpnt .L945
	;;
	.align 32
.L948:
	.mmi

...
wmemmove:
	...
	nop 0
	(p7) br.cond.dptk .L547
	;;
	.mib
	shladd r14 = r14, 2, r0
	cmp.eq p6, p7 = 0, r34
	(p6) br.cond.dpnt .L539
	;;
	.mmi
	nop 0
	add r33 = r33, r14
...
__cmovd:
	...
	nop 0
	nop 0
	(p7) br.cond.dptk .L852
	;;
	.mib
	nop 0
	cmp.ltu p6, p7 = r17, r32
	(p7) br.cond.dptk .L863
	;;
.L852:
	.mii
	cmp4.ne p6, p7 = 0, r19
...
__cmovh:
	...
	nop 0
	nop 0
	(p7) br.cond.dptk .L868
	;;
	.mib
	nop 0
	cmp.ltu p6, p7 = r17, r32
	(p7) br.cond.dptk .L878
	;;
.L868:
	.mii
	cmp4.ne p6, p7 = 0, r18

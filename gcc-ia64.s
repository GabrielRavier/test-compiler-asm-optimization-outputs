...
__cmovh:
	...
	nop 0
	cmp.ltu p6, p7 = r17, r32
	(p7) br.cond.dptk .L813
	;;
.L800:
	.mib
	shladd r16 = r16, 1, r0
	cmp4.eq p6, p7 = 0, r18
	(p6) br.cond.dpnt .L803
	;;
	.mii
	adds r16 = -2, r16
	nop 0
...
.L1123:
	...
	cmp4.eq p6, p7 = 0, r14
	nop 0
	(p7) br.cond.dptk .L1123
	;;
.L1118:
	.mbb
	cmp4.le p6, p7 = r0, r33
	(p7) br.cond.dpnt .L1124
	br.ret.sptk.many b0
	;;
.L1124:
	.mmf

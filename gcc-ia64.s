...
swab:
	...
	.mii
	nop 0
	unpack1.l r23 = r16, r17
	unpack1.h r22 = r16, r17
	;;
	.mii
	nop 0
	mux1 r16 = r25, @alt
...
__cmovh:
	...
	(p7) br.cond.dptk .L1301
	;;
.L1243:
	.mib
	nop 0
	cmp4.ne p6, p7 = 0, r17
	(p7) br.cond.dpnt .L1242
	.mmi
	nop 0
	adds r14 = -1, r17
	nop 0
...
.L1389:
	...
	adds r17 = -1, r34
	cmp4.ne p6, p7 = 0, r34
	(p7) br.cond.dpnt .L1308
	;;
	.mib
	addp4 r18 = r17, r0
	cmp4.geu p6, p7 = 8, r17
	(p6) br.cond.dpnt .L1324
	;;
	.mmi
	adds r14 = -7, r18
	adds r19 = -1, r18
...
.L1525:
	...
	(p6) br.cond.dptk .L1525
	.mib
	nop 0
	(p9) mov r8 = r0
	(p9) br.cond.dpnt .L1527
	;;
.L1526:
	.mmi
	mov r8 = r0
...
.L1543:
	...
	nop 0
	(p9) cmp4.ne.and.orcm p6, p7 = 0, r0
	(p6) br.cond.dptk .L1543
	.mib
	nop 0
	nop 0
	(p9) br.cond.dpnt .L1545
	;;
	.align 32
.L1560:
	.mmi

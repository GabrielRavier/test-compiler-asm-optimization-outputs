...
memxor:
	...
	nop 0
	nop 0
	(p6) br.cond.dpnt .L908
	;;
	.mib
	cmp.geu p6, p7 = 6, r20
	nop 0
	(p6) br.cond.dpnt .L909
	;;
	.mib
	nop 0
	cmp.ne p6, p7 = 0, r15
...
.L1550:
	...
	nop 0
	(p9) cmp4.ne.and.orcm p6, p7 = 0, r0
	(p6) br.cond.dptk .L1550
	.mib
	nop 0
	nop 0
	(p9) br.cond.dpnt .L1552
	;;
	.align 32
.L1567:
	.mmi

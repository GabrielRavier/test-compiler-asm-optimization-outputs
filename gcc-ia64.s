...
fdim:
	...
	nop 0
	(p6) mov f8 = f6
	(p6) br.cond.dpnt .L266
	;;
	.mfb
	nop 0
	(p8) mov f8 = f9
	(p8) br.cond.dpnt .L266
	;;
	.mmf
	nop 0
	nop 0
...
fdimf:
	...
	nop 0
	(p6) mov f8 = f6
	(p6) br.cond.dpnt .L276
	;;
	.mfb
	nop 0
	(p8) mov f8 = f9
	(p8) br.cond.dpnt .L276
	;;
	.mmf
	nop 0
	nop 0
...
memxor:
	...
	nop 0
	nop 0
	(p6) br.cond.dpnt .L848
	;;
	.mib
	cmp.geu p6, p7 = 6, r20
	nop 0
	(p6) br.cond.dpnt .L849
	;;
	.mib
	nop 0
	cmp.ne p6, p7 = 0, r15
...
.L997:
	...
	.bbb
	nop 0
	(p7) br.cond.dpnt .L991
	br.cloop.sptk.few .L975
	;;
	.mib
	nop 0
	mov ar.lc = r2
...
__cmovd:
	...
	mov r2 = ar.lc
	.body
	(p7) br.cond.dptk .L1078
	;;
	.mib
	nop 0
	cmp.ltu p6, p7 = r15, r32
	(p7) br.cond.dptk .L1128
	;;
.L1078:
	.mib
	nop 0
	cmp4.ne p6, p7 = 0, r14
	(p7) br.cond.dpnt .L1129
	.mmi
	addp4 r16 = r14, r0
	mov r15 = r33
	mov r14 = r32
...
__cmovh:
	...
	nop 0
	nop 0
	(p7) br.cond.dptk .L1179
	;;
	.mib
	nop 0
	cmp.ltu p6, p7 = r14, r32
	(p7) br.cond.dptk .L1176
	;;
.L1179:
	.mib
	adds r14 = -1, r17
...
.L1236:
	...
	adds r14 = -1, r18
	cmp4.ne p6, p7 = 0, r18
	(p7) br.cond.dpnt .L1235
	;;
	.mib
	cmp4.geu p6, p7 = 8, r14
	or r14 = r33, r32
	(p6) br.cond.dpnt .L1187
	;;
	.mii
	and r14 = 7, r14
...
.L1380:
	...
	nop 0
	(p9) cmp4.ne.and.orcm p6, p7 = 0, r0
	(p6) br.cond.dptk .L1380
	.mib
	nop 0
	nop 0
	(p9) br.cond.dpnt .L1382
	;;
	.align 32
.L1396:
	.mmi

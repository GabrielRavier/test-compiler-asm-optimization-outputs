...
OPT_FLAGS = -Ofast -fno-allow-store-data-races -fno-math-errno -fno-unsafe-math-optimizations -fno-finite-math-only -frounding-math -fsignaling-nans -fno-cx-limited-range -fexcess-precision=standard

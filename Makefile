...
> mips64-linux-gnu-gcc -S $< -o $@ $(GCC_OPT_FLAGS) -march=mips64 $(GCC_MIPS_OPTIONS)

gcc-mips32.s: mini-libc.c
> mips64-linux-gnu-gcc -mabi=32 -S $< -o $@ $(GCC_OPT_FLAGS) -march=mips32 -mfp32 $(GCC_MIPS_OPTIONS)

...
GCC_SPARC_OPTIONS = -mapp-regs -mno-flat -mhard-float -mhard-quad-float -mlra -mv8plus -mvis -mvis2 -mvis3 -mvis4 -mcbcond -mfmaf -mfsmuld -mpopc -msubxc -mcpu=m8 -mtune=niagara3

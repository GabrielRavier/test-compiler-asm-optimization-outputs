...
OPT_FLAGS = -O2 -fno-thread-jumps -fno-tree-builtin-call-dce -fno-tree-loop-vectorize -fno-tree-pre -fno-tree-slp-vectorize -fno-tree-switch-conversion -fno-tree-tail-merge -fno-tree-vrp -fvect-cost-model=very-cheap

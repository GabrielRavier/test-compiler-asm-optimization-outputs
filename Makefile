...
GCC_RISCV_ARCH_EXTENSIONS = i2p1_m2p0_a2p1_f2p2_d2p2_c2p0_h1p0_v1p0_zicsr2p0_zifencei2p0_zicond1p0_za64rs1p0_za128rs1p0_zawrs1p0_zba1p0_zbb1p0_zbc1p0_zbs1p0

...
> x86_64-linux-gnu-gcc -masm=intel -m32 -S $< -o $@ $(GCC_OPT_FLAGS) -march=i386 -mtune=generic
...
> x86_64-w64-mingw32-gcc -masm=intel -S $< -o $@ $(GCC_OPT_FLAGS) -mtune=generic

...
GCC_OPT_FLAGS = -O3 -fmodulo-sched -fmodulo-sched-allow-regmoves -fgcse-sm -fgcse-las -fdelete-null-pointer-checks -fdevirtualize-speculatively -fdevirtualize-at-ltrans -free -flive-range-shrinkage -fira-hoist-pressure -fsched-pressure -fsched-spec-load -fsched-spec-load-dangerous -fno-semantic-interposition -ffinite-loops -ftree-loop-im -ftree-loop-ivcanon -fivopts -ftree-vectorize -fvariable-expansion-in-unroller -fno-unreachable-traps -fweb -frename-registers

...
> nios2-linux-gnu-gcc -S $< -o $@ $(GCC_OPT_FLAGS) -march=r1 -mel -mhw-mul -mhw-mulx -mhw-div -mcustom-floatus=243 -mcustom-fixsi=244 -mcustom-floatis=245 -mcustom-fcmpgts=246 -mcustom-fmuls=252 -mcustom-fadds=253 -mcustom-fsubs=254 -mcustom-fdivs=255

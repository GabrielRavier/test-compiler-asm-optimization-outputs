...
> arc-linux-gnu-gcc -S $< -o $@ $(GCC_OPT_FLAGS) -mbarrel-shifter -mnorm -mswap -matomic -mdiv-rem -mcode-density -mll64 -mmpy-option=plus_qmacw -mfpu=fpud_div -mfpu=fpud_all -mbranch-index -mauto-modify-reg -mearly-cbranchsi -mindexed-loads

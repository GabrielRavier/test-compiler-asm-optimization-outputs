...
> microblaze-linux-gnu-gcc -S $< -o $@ $(GCC_OPT_FLAGS) -mhard-float -mno-xl-soft-mul -mno-xl-soft-div -mxl-barrel-shift -mxl-pattern-compare -mxl-multiply-high -mxl-float-convert

...
GCC_MIPS_OPTIONS = -EL -mmips16e2 -mhard-float -modd-spreg -mabs=2008 -mnan=2008 -mllsc -mdsp -mdspr2 -msmartmips -mdmx -mmt -mmcu -meva -mvirt -mxpa -mcrc -mginv -mloongson-mmi -mloongson-ext -mloongson-ext2 -mload-store-pairs -mno-strict-align -mmad -mbranch-likely

...
GCC_X86_OPTIONS = -mhard-float -mieee-fp -mcx16 -msahf -mmovbe -mshstk -mcrc32 -mmwait -momit-leaf-frame-pointer -mmmx -msse -msse2 -msse3 -mssse3 -msse4 -msse4a -msse4.1 -msse4.2 -mavx -mavx2

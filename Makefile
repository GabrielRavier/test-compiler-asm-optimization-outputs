...
OPT_FLAGS = -Ofast -frounding-math -fsignaling-nans -fno-cx-limited-range -fexcess-precision=standard -fsigned-zeros -ftrapping-math -fno-associative-math -fno-reciprocal-math

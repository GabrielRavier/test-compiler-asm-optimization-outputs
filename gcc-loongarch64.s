...
.LFB133 = .
	...
	beqz	$r12,.L608
	or	$r12,$r0,$r0
	bstrins.d	$r12,$r0,31,0
	sll.w	$r4,$r4,$r5
	bstrins.d	$r12,$r4,63,32
	b	.L609
.L608:
	beqz	$r5,.L610
	sll.w	$r13,$r4,$r5
	or	$r12,$r0,$r0
	bstrins.d	$r12,$r13,31,0
	srai.d	$r13,$r4,32
	sll.w	$r13,$r13,$r5
	sub.w	$r5,$r0,$r5
	srl.w	$r4,$r4,$r5
...
.LFB135 = .
	...
	srai.w	$r12,$r4,31
	or	$r13,$r0,$r0
	bstrins.d	$r13,$r12,63,32
	sra.w	$r4,$r4,$r5
	bstrins.d	$r13,$r4,31,0
	b	.L619
.L618:
	beqz	$r5,.L620
	srai.d	$r12,$r4,32
	sra.w	$r14,$r12,$r5
	or	$r13,$r0,$r0
	bstrins.d	$r13,$r14,63,32
	sub.w	$r14,$r0,$r5
	sll.w	$r12,$r12,$r14
	srl.w	$r4,$r4,$r5
	or	$r12,$r12,$r4
	slli.w	$r12,$r12,0
	bstrins.d	$r13,$r12,31,0
.L619:
	or	$r4,$r13,$r0
.L620:
	ld.d	$r22,$r3,8
...
.LFB147 = .
	...
	beqz	$r12,.L667
	or	$r13,$r0,$r0
	bstrins.d	$r13,$r0,63,32
	bstrpick.d	$r4,$r4,63,32
	srl.w	$r5,$r4,$r5
	bstrins.d	$r13,$r5,31,0
	b	.L668
.L667:
	beqz	$r5,.L669

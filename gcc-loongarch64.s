...
.LFB101 = .
	...
	fld.d	$f1,$r12,%pc_lo12(.LC18)
	or	$r14,$r0,$r0
	fcmp.sge.d	$fcc0,$f0,$f1
	bceqz	$fcc0,.L834
.L813:
	pcalau12i	$r13,%pc_hi20(.LC13)
	fld.d	$f2,$r13,%pc_lo12(.LC13)
	or	$r12,$r0,$r0
	.align	3
.L819:
	fmul.d	$f0,$f0,$f2

...
fmax:
	...
	addk	r6,r23,r0
	bnei	r3,$L226
	andi	r5,r25,-2147483648 #and2
	andi	r6,r23,-2147483648 #and2
	xor	r7,r5,r6
	beqid	r7,$L221
	addk	r8,r23,r0
	beqi	r5,$L226
...
fmin:
	...
	addk	r6,r25,r0
	bnei	r3,$L256
	andi	r5,r23,-2147483648 #and2
	andi	r6,r25,-2147483648 #and2
	xor	r7,r5,r6
	beqid	r7,$L258
	addk	r8,r25,r0
	beqi	r5,$L262
...
ldexp:
	...
	addik	r25,r0,0x40000000 #Xfer Lo
	andi	r3,r19,1 #and1
$L714:
	beqid	r3,$L716
	bsrli	r4,r19,31
...
$L713:
	addik	r24,r0,0x00000000 
	addik	r25,r0,0x3fe00000 #Xfer Lo
	brid	$L714
	andi	r3,r19,1 #and1
	.end	ldexp
$Lfe89:
...
frexp:
	...
	addk	r5,r22,r0
	addik	r7,r0,0x00000000 
	addik	r8,r0,0x3ff00000 #Xfer Lo
	addk	r6,r23,r0
	brlid	r15,__gedf2
	...
	addk	r5,r22,r0
$L871:
	addik	r26,r0,0x00000000 
	addik	r27,r0,0x3fe00000 #Xfer Lo
	addik	r24,r0,0x00000000 
	addik	r25,r0,0x3ff00000 #Xfer Lo
	addk	r19,r0,r0
	addk	r5,r22,r0
$L897:
	addk	r6,r23,r0
...
$L893:
	addik	r7,r0,0x00000000 
	addik	r8,r0,0x3fe00000 #Xfer Lo
	brlid	r15,__ltdf2
...
$L892:
	addik	r7,r0,0x00000000 
	addik	r8,r0,0xbff00000 #Xfer Lo
	addk	r6,r23,r0
	addik	r27,r23,-2147483648
	brlid	r15,__ledf2
...
$L894:
	addik	r7,r0,0x00000000 
	addik	r8,r0,0xbfe00000 #Xfer Lo
	addk	r5,r22,r0
	brlid	r15,__gtdf2
...
__muldi3_compiler_rt:
	.frame	r1,0,r15		# vars= 0, regs= 0, args= 0
	.mask	0x00000000
	andi	r9,r7,65535 #and2
	andi	r10,r5,65535 #and2
	mul	r3,r10,r9
	bsrli	r11,r5,16
	bsrli	r4,r7,16
	mul	r12,r9,r11
...
__popcountdi2:
	...
	swi	r22,r1,4
	swi	r23,r1,8
	andi	r22,r3,1431655765 #and2
	andi	r23,r4,1431655765 #and2
	rsub	r6,r22,r8
	rsubc	r7,r23,r9
	bsrli	r8,r6,2
	bsrli	r9,r7,2
	...
	add	r6,r4,r10
	addc	r7,r5,r11
	andi	r12,r6,252645135 #and2
	andi	r7,r7,252645135 #and2
	addk	r22,r7,r12
	bsrli	r23,r22,16
	addk	r10,r23,r22
	bsrli	r11,r10,8
...
__powidf2:
	...
	addik	r23,r0,0x3ff00000 #Xfer Lo
	beqid	r3,$L1676
	addk	r19,r7,r0
$L1678:
	addk	r5,r22,r0
...
$L1677:
	...
	addik	r6,r0,0x3ff00000 #Xfer Lo
	brlid	r15,__divdf3

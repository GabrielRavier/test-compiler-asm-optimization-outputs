...
.L1130:
	...
	extru %r19,31,16,%r19
.L1131:
	extru %r22,14+16-1,16,%r21
	comib,= 0,%r21,.L1152
	extru %r25,29,30,%r20
	comb,>> %r20,%r26,.L1188
	extru %r22,13+16-1,16,%r23
	sub %r26,%r20,%r26
	or %r19,%r21,%r1
	extru %r26,31,16,%r26
	extru %r1,31,16,%r19
...
.L1192:
	...
	or %r19,%r1,%r29
.L1137:
	extru %r22,8+16-1,16,%r31
	comib,= 0,%r31,.L1152
	extru %r25,23,24,%r28
	comb,<<= %r28,%r26,.L1184
	sub %r26,%r28,%r21
.L1138:
	extru %r22,7+16-1,16,%r1
	comib,= 0,%r1,.L1152
	extru %r25,22,23,%r23
	comclr,>> %r23,%r26,%r0
	b,n .L1185
.L1139:
	extru %r22,6+16-1,16,%r29
	comib,= 0,%r29,.L1152
	extru %r25,21,22,%r31
	comb,<<= %r31,%r26,.L1186
	sub %r26,%r31,%r21
.L1140:
	extru %r22,5+16-1,16,%r1
	comib,= 0,%r1,.L1152
	extru %r25,20,21,%r20
	comclr,>> %r20,%r26,%r0
	b,n .L1187
.L1141:
	extru %r22,4+16-1,16,%r29
	comib,= 0,%r29,.L1152
	extru %r25,19,20,%r31
	comb,>> %r31,%r26,.L1193

...
$L831:
	...
	bis $31,$31,$31
$L811:
	ldah $3,$LC22($29)		!gprelhigh
	cpys $f12,$f12,$f16
	mov $31,$1
	lds $f12,$LC22($3)		!gprellow
	.align 4
$L818:
	cpys $f16,$f16,$f11
	subl $1,1,$1
...
$__popcountdi2..ng:
	...
	srl $16,2,$2
	ldq $1,$LC26($1)		!gprellow
	and $16,$1,$16
	and $2,$1,$2
	addq $2,$16,$2
	srl $2,4,$1
	addq $1,$2,$1
	ldah $2,$LC27($29)		!gprelhigh
	ldq $2,$LC27($2)		!gprellow
	and $1,$2,$1
	srl $1,32,$2
	addl $2,$1,$2
	zapnot $2,15,$1
...
$__popcountti2..ng:
	...
	srl $1,4,$2
	bis $4,$2,$2
	ldah $4,$LC27($29)		!gprelhigh
	addq $2,$1,$1
	cmpult $1,$2,$2
	ldq $5,$LC27($4)		!gprellow
	srl $3,4,$4
	addq $4,$3,$3
	addq $2,$3,$2
	and $1,$5,$1

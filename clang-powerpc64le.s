...
# %bb.0:
	...
	ld %r3, -32(%r1)                        # 8-byte Folded Reload
                                        # kill: def $r3 killed $r3 killed $x3
                                        # kill: def $r4 killed $r4 killed $x4
	addis %r5, %r2, .LC109@toc@ha
	ld %r6, .LC109@toc@l(%r5)
	ld %r5, 0(%r6)
	addi %r5, %r5, 1
	std %r5, 0(%r6)
	stw %r4, -20(%r1)
...
# %bb.0:
	addis %r5, %r2, .LC113@toc@ha
	ld %r6, .LC113@toc@l(%r5)
	ld %r5, 0(%r6)
	addi %r5, %r5, 1
	std %r5, 0(%r6)
	std %r3, -32(%r1)
...
# %bb.0:
	addis %r5, %r2, .LC117@toc@ha
	ld %r6, .LC117@toc@l(%r5)
	ld %r5, 0(%r6)
	addi %r5, %r5, 1
	std %r5, 0(%r6)
	std %r3, -32(%r1)
...
# %bb.0:
	addis %r5, %r2, .LC121@toc@ha
	ld %r6, .LC121@toc@l(%r5)
	ld %r5, 0(%r6)
	addi %r5, %r5, 1
	std %r5, 0(%r6)
	std %r3, -32(%r1)
...
.Lfunc_toc166:                          # @__llvm_gcov_writeout
	.quad	.TOC.-.Lfunc_gep166
__llvm_gcov_writeout:
.Lfunc_begin166:
	.cfi_startproc
.Lfunc_gep166:
	ld %r2, .Lfunc_toc166-.Lfunc_gep166(%r12)
	add %r2, %r2, %r12
.Lfunc_lep166:
	.localentry	__llvm_gcov_writeout, .Lfunc_lep166-.Lfunc_gep166
# %bb.0:
	mflr %r0
	std %r31, -8(%r1)
	stdu %r1, -96(%r1)
...
.LBB166_1:                              # =>This Loop Header: Depth=1
	...
	stw %r4, 44(%r31)                       # 4-byte Folded Spill
	...
	ld %r3, 48(%r31)                        # 8-byte Folded Reload
	lwz %r4, 16(%r3)
	stw %r4, 60(%r31)                       # 4-byte Folded Spill
	ld %r5, 24(%r3)
	std %r5, 64(%r31)                       # 8-byte Folded Spill
	ld %r3, 32(%r3)
	std %r3, 72(%r31)                       # 8-byte Folded Spill
	li %r3, 0
	cmpw	%r3, %r4
...
.LBB166_2:                              #   Parent Loop BB166_1 Depth=1
	...
	ld %r5, 64(%r31)                        # 8-byte Folded Reload
	stw %r3, 40(%r31)                       # 4-byte Folded Spill
	extsw %r3, %r3
	std %r3, 32(%r31)                       # 8-byte Folded Spill
	mulli %r3, %r3, 12
...
.Lfunc_toc167:                          # @__llvm_gcov_reset
	.quad	.TOC.-.Lfunc_gep167
__llvm_gcov_reset:
.Lfunc_begin167:
	.cfi_startproc
.Lfunc_gep167:
	ld %r2, .Lfunc_toc167-.Lfunc_gep167(%r12)
	add %r2, %r2, %r12
.Lfunc_lep167:
	.localentry	__llvm_gcov_reset, .Lfunc_lep167-.Lfunc_gep167
# %bb.0:
...
.Lfunc_toc168:                          # @__llvm_gcov_init
	.quad	.TOC.-.Lfunc_gep168
__llvm_gcov_init:
.Lfunc_begin168:
	.cfi_startproc
.Lfunc_gep168:
	ld %r2, .Lfunc_toc168-.Lfunc_gep168(%r12)
	add %r2, %r2, %r12
.Lfunc_lep168:
	.localentry	__llvm_gcov_init, .Lfunc_lep168-.Lfunc_gep168
# %bb.0:
	mflr %r0
	std %r31, -8(%r1)
	stdu %r1, -48(%r1)
...
.L__unnamed_1:
	.asciz	"/home/gravier/tmp/some-libc-opt/clang-powerpc64le.gcda"

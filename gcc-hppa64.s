...
.L613:
	...
	ldi 0,%r28
	copy %r28,%r29
	depd,z %r20,%sar,64,%r29
	depd,z %r19,%sar,64,%r19
	subi 64,%r31,%r31
	mtsar %r31
	shrpd %r0,%r20,%sar,%r20
	or %r20,%r19,%r20
	copy %r20,%r28
.L614:
	copy %r28,%r21
...
.L623:
	...
	ldi 0,%r28
	copy %r28,%r29
	extrd,s %r21,%sar,64,%r28
	subi 64,%r31,%r19
	extrd,s %r19,63,32,%r19
	mtsarcm %r19
	depd,z %r21,%sar,64,%r21
	mtsar %r31
...
.L672:
	...
	copy %r28,%r29
	mtsar %r31
	shrpd %r0,%r20,%sar,%r28
	subi 64,%r31,%r19
	extrd,s %r19,63,32,%r19
	mtsarcm %r19
	depd,z %r20,%sar,64,%r20
	mtsar %r31
...
__popcountti2:
	...
	ldi 0,%r19
	copy %r19,%r20
	extrd,u %r29,62,63,%r20
	or %r31,%r20,%r20
	extrd,u %r28,62,63,%r19
	addil LT'.LC40,%r27
	ldd RT'.LC40(%r1),%r31
	ldd 0(%r31),%r31
	ldi 0,%r21

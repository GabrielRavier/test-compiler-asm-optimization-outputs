...
.L1524:
	...
	copy %r26,%r23
.L1422:
	extrd,u %r23,63,16,%r28
	cmpb,<<= %r25,%r26,.L1424
	extrd,u %r19,63,16,%r29
	ldi 0,%r29
.L1424:
	extrd,u %r19,47+16-1,16,%r26
	cmpb,*<> %r0,%r26,.L1426
...
.L1320:
	...
	sub %r26,%r31,%r29
	cmpb,>> %r31,%r26,.L1526
	extrd,u %r29,63,16,%r28
.L1329:
	extrd,u %r19,63,15,%r26
	extrd,u %r25,63,15,%r1
	extrd,u %r22,63,16,%r29
	copy %r21,%r19
	copy %r31,%r25
.L1426:
	sub %r28,%r1,%r31
...
.L1336:
	or %r26,%r29,%r1
	extrd,u %r19,46+16-1,16,%r20
	extrd,u %r1,63,16,%r21
	cmpb,*= %r0,%r20,.L1324
	extrd,u %r25,61,62,%r26
	sub %r28,%r26,%r23
	ldi 1,%r29
	cmpb,<<= %r26,%r28,.L1337
	extrd,u %r23,63,16,%r31
	ldi 0,%r29
.L1337:
	cmpclr,<<= %r26,%r28,%r0
	copy %r28,%r31
.L1340:
	cmpb,*<> %r0,%r29,.L1342
	extrd,u %r31,63,16,%r28
	copy %r29,%r20
.L1342:
	or %r20,%r21,%r22
	extrd,u %r19,45+16-1,16,%r31
	extrd,u %r22,63,16,%r21
	cmpb,*= %r0,%r31,.L1324
	extrd,u %r25,60,61,%r1
	sub %r28,%r1,%r26
	ldi 1,%r23
	cmpb,<<= %r1,%r28,.L1343
	extrd,u %r26,63,16,%r29
	ldi 0,%r23
.L1343:
	cmpclr,<<= %r1,%r28,%r0
	copy %r28,%r29
...
.L1348:
	or %r31,%r21,%r21
	extrd,u %r19,44+16-1,16,%r22
	extrd,u %r21,63,16,%r21
	cmpb,*= %r0,%r22,.L1324
	extrd,u %r25,59,60,%r1
	sub %r28,%r1,%r26
	ldi 1,%r20
	cmpb,<<= %r1,%r28,.L1349
	extrd,u %r26,63,16,%r23
	ldi 0,%r20
.L1349:
	cmpclr,<<= %r1,%r28,%r0
	copy %r28,%r23
...
.L1354:
	or %r22,%r21,%r29
	extrd,u %r25,58,59,%r1
	extrd,u %r19,43+16-1,16,%r22
	cmpb,*= %r0,%r22,.L1324
...
.L1360:
	or %r22,%r21,%r21
	extrd,u %r19,42+16-1,16,%r26
	extrd,u %r21,63,16,%r21
	cmpb,*= %r0,%r26,.L1324
	extrd,u %r25,57,58,%r29
	sub %r28,%r29,%r1
	ldi 1,%r20
	cmpb,<<= %r29,%r28,.L1361
	extrd,u %r1,63,16,%r31
	ldi 0,%r20
.L1361:
	cmpclr,<<= %r29,%r28,%r0
	copy %r28,%r31
...
.L1372:
	or %r20,%r21,%r21
	extrd,u %r25,55,56,%r26
	extrd,u %r19,40+16-1,16,%r20
	cmpb,*= %r0,%r20,.L1324
	extrd,u %r21,63,16,%r21
	sub %r28,%r26,%r23
	ldi 1,%r29
	cmpb,>> %r26,%r28,.L1529
	extrd,u %r23,63,16,%r1
	cmpclr,<<= %r26,%r28,%r0
	b,n .L1530
.L1376:
	cmpb,*<> %r0,%r29,.L1378
	extrd,u %r1,63,16,%r28
	copy %r29,%r20
.L1378:
	or %r20,%r21,%r22
	extrd,u %r19,39+16-1,16,%r1
	extrd,u %r22,63,16,%r21
	cmpb,*= %r0,%r1,.L1324
	extrd,u %r25,54,55,%r26
	sub %r28,%r26,%r31
	ldi 1,%r23
	cmpb,>> %r26,%r28,.L1531
	extrd,u %r31,63,16,%r29
	cmpclr,<<= %r26,%r28,%r0
	b,n .L1532
.L1382:
	cmpb,*<> %r0,%r23,.L1384
...
.L1384:
	or %r1,%r21,%r21
	extrd,u %r19,38+16-1,16,%r22
	extrd,u %r21,63,16,%r21
	cmpb,*= %r0,%r22,.L1324
	extrd,u %r25,53,54,%r26
	sub %r28,%r26,%r31
	ldi 1,%r20
	cmpb,>> %r26,%r28,.L1533
	extrd,u %r31,63,16,%r23
...
.L1390:
	or %r22,%r21,%r29
	extrd,u %r25,52,53,%r1
	extrd,u %r19,37+16-1,16,%r22
	cmpb,*= %r0,%r22,.L1324
	extrd,u %r29,63,16,%r21
	sub %r28,%r1,%r26
	ldi 1,%r23
...
.L1396:
	or %r22,%r21,%r21
	extrd,u %r19,36+16-1,16,%r23
	extrd,u %r21,63,16,%r21
	cmpb,*= %r0,%r23,.L1324
	extrd,u %r25,51,52,%r29
	sub %r28,%r29,%r1
	ldi 1,%r20
	cmpb,>> %r29,%r28,.L1539
...
.L1402:
	or %r23,%r21,%r31
	extrd,u %r19,35+16-1,16,%r20
	extrd,u %r31,63,16,%r21
	cmpb,*= %r0,%r20,.L1324
	extrd,u %r25,50,51,%r29
	sub %r28,%r29,%r1
	ldi 1,%r22
	cmpb,<<= %r29,%r28,.L1403
	extrd,u %r1,63,16,%r26
...
.L1408:
	or %r20,%r21,%r21
	extrd,u %r25,49,50,%r23
	extrd,u %r19,34+16-1,16,%r20
	cmpb,*= %r0,%r20,.L1324
	extrd,u %r21,63,16,%r21
	sub %r28,%r23,%r31
	ldi 1,%r29
	cmpb,<<= %r23,%r28,.L1409
	extrd,u %r31,63,16,%r1
	ldi 0,%r29
.L1409:
	cmpclr,<<= %r23,%r28,%r0
	copy %r28,%r1
...
.L1523:
	xor %r25,%r26,%r21
	sub %r26,%r25,%r28
	extrw,s,>= %r21,31,16,%r1
	subi 0,%r1,%r1
	extrd,u %r28,63,16,%r28
	ldo -1(%r1),%r19
	extrw,u %r19,16+1-1,1,%r20
	extrd,u %r20,63,8,%r31
	cmpiclr,*<> 0,%r31,%r0
	copy %r26,%r28
	b .L1324
	extrd,u %r20,63,16,%r21
	.EXIT
	.PROCEND
...
.L1559:
	sub %r26,%r25,%r23
	cmpb,*<<= %r25,%r26,.L1553
	extrd,u %r21,63,8,%r29
	extrd,u %r22,63,8,%r29
.L1553:
	cmpclr,*>> %r25,%r26,%r0
	copy %r23,%r26
	ldi 0,%r19

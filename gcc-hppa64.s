...
.L1278:
	...
	cmpb,*= %r0,%r19,.L1281
	extrd,u %r25,62,63,%r28
.L1259:
	cmpb,>> %r28,%r26,.L1260
	sub %r26,%r28,%r28
	or %r21,%r19,%r19
	extrd,u %r28,63,16,%r26
	extrd,u %r19,63,16,%r21
.L1260:
	extrd,u %r20,46+16-1,16,%r28
	cmpb,*= %r0,%r28,.L1281
...
.L1253:
	cmpb,*= %r0,%r21,.L1257
	copy %r26,%r28
	cmpb,>>,n %r31,%r26,.L1258
	sub %r26,%r31,%r26
	extrd,u %r20,63,15,%r19
	extrd,u %r25,63,15,%r28
	extrd,u %r26,63,16,%r26
	copy %r31,%r25
	b .L1259
	copy %r21,%r20

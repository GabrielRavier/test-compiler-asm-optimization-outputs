...
.L1217:
	lcdbr	%f6,%f0
	kdb	%f0,.L1223-.L1220(%r5)
	jnle	.L1219
	ldr	%f0,%f6
	lhi	%r3,1
	j	.L1197
.L1219:
	kdb	%f0,.L1224-.L1220(%r5)
	jnh	.L1200
	lhi	%r3,1
.L1198:
	ldr	%f0,%f6
...
.LFB118:
	.cfi_startproc
	larl	%r5,.L1621
	keb	%f0,.L1622-.L1621(%r5)
	jhe	.L1620
	cgebr	%r2,5,%f0
	br	%r14
.L1620:
	seb	%f0,.L1622-.L1621(%r5)
	cgebr	%r2,5,%f0
	algfi	%r2,32768
	br	%r14
	.section	.rodata
...
.LFB158:
	...
	larl	%r5,.L2282
	srlg	%r1,%r2,1
	ng	%r1,.L2283-.L2282(%r5)
	sgr	%r2,%r1
	srlg	%r0,%r2,2
	ng	%r2,.L2284-.L2282(%r5)
	ng	%r0,.L2284-.L2282(%r5)
	agr	%r2,%r0
	srlg	%r3,%r2,4
	agr	%r3,%r2
	ng	%r3,.L2285-.L2282(%r5)
	srlg	%r2,%r3,32
	ar	%r2,%r3
	srlk	%r4,%r2,16
	ar	%r4,%r2

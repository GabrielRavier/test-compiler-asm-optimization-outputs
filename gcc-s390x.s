...
.L1089:
	lcdbr	%f6,%f0
	kdb	%f0,.L1095-.L1092(%r5)
	jnle	.L1091
	ldr	%f0,%f6
	lhi	%r3,1
	j	.L1069
.L1091:
	kdb	%f0,.L1096-.L1092(%r5)
	jh	.L1079
	ldr	%f0,%f6
	mvhi	0(%r2),0
	lcdbr	%f0,%f0
...
.LFB118:
	.cfi_startproc
	larl	%r5,.L1381
	keb	%f0,.L1382-.L1381(%r5)
	jhe	.L1380
	cgebr	%r2,5,%f0
	br	%r14
.L1380:
	seb	%f0,.L1382-.L1381(%r5)
	cgebr	%r2,5,%f0
	algfi	%r2,32768
	br	%r14
	.section	.rodata
...
.LFB158:
	...
	larl	%r5,.L1671
	srlg	%r1,%r2,1
	ng	%r1,.L1672-.L1671(%r5)
	sgr	%r2,%r1
	srlg	%r0,%r2,2
	ng	%r2,.L1673-.L1671(%r5)
	ng	%r0,.L1673-.L1671(%r5)
	agr	%r2,%r0
	srlg	%r3,%r2,4
	agr	%r3,%r2
	ng	%r3,.L1674-.L1671(%r5)
	srlg	%r2,%r3,32
	ar	%r2,%r3
	srlk	%r4,%r2,16
	ar	%r4,%r2

...
.LFB118:
	.cfi_startproc
	larl	%r5,.L1970
	keb	%f0,.L1971-.L1970(%r5)
	jhe	.L1969
	cgebr	%r2,5,%f0
	br	%r14
.L1969:
	seb	%f0,.L1971-.L1970(%r5)
	cgebr	%r2,5,%f0
	algfi	%r2,32768
	br	%r14
	.section	.rodata
...
.LFB158:
	...
	larl	%r5,.L2631
	srlg	%r1,%r2,1
	ng	%r1,.L2632-.L2631(%r5)
	sgr	%r2,%r1
	srlg	%r0,%r2,2
	ng	%r2,.L2633-.L2631(%r5)
	ng	%r0,.L2633-.L2631(%r5)
	agr	%r2,%r0
	srlg	%r3,%r2,4
	agr	%r3,%r2
	ng	%r3,.L2634-.L2631(%r5)
	srlg	%r2,%r3,32
	ar	%r2,%r3
	srlk	%r4,%r2,16
	ar	%r4,%r2

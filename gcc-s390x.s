...
.LFB158:
	...
	larl	%r5,.L2761
	srlg	%r1,%r2,1
	ng	%r1,.L2762-.L2761(%r5)
	sgr	%r2,%r1
	srlg	%r0,%r2,2
	ng	%r2,.L2763-.L2761(%r5)
	ng	%r0,.L2763-.L2761(%r5)
	agr	%r2,%r0
	srlg	%r3,%r2,4
	agr	%r3,%r2
	ng	%r3,.L2764-.L2761(%r5)
	srlg	%r2,%r3,32
	ar	%r2,%r3
	srlk	%r4,%r2,16
	ar	%r4,%r2

...
.LFB158:
	...
	larl	%r5,.L1049
	srlg	%r1,%r2,1
	ng	%r1,.L1050-.L1049(%r5)
	sgr	%r2,%r1
	srlg	%r1,%r2,2
	ng	%r1,.L1051-.L1049(%r5)
	ng	%r2,.L1051-.L1049(%r5)
	agr	%r2,%r1
	srlg	%r1,%r2,4
	agr	%r1,%r2
	ng	%r1,.L1052-.L1049(%r5)
	srlg	%r2,%r1,32
	ar	%r2,%r1
	srlk	%r1,%r2,16
	ar	%r1,%r2

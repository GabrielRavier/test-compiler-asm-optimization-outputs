...
.LFB118:
	.cfi_startproc
	larl	%r5,.L1150
	keb	%f0,.L1151-.L1150(%r5)
	jhe	.L1149
	cgebr	%r2,5,%f0
	br	%r14
.L1149:
	seb	%f0,.L1151-.L1150(%r5)
	cgebr	%r2,5,%f0
	algfi	%r2,32768
	br	%r14
	.section	.rodata
...
.LFB158:
	...
	larl	%r5,.L1396
	srlg	%r1,%r2,1
	ng	%r1,.L1397-.L1396(%r5)
	sgr	%r2,%r1
	srlg	%r0,%r2,2
	ng	%r0,.L1398-.L1396(%r5)
	ng	%r2,.L1398-.L1396(%r5)
	agr	%r2,%r0
	srlg	%r3,%r2,4
	agr	%r3,%r2
	ng	%r3,.L1399-.L1396(%r5)
	srlg	%r2,%r3,32
	ar	%r2,%r3
	srlk	%r4,%r2,16
	ar	%r4,%r2

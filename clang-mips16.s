...
$BB85_1:
	...
	jal	__addsf3
	nop
	lw	$5, 32($16)                     # 4-byte Folded Reload
	move	$4, $2
	jal	__eqsf2
	nop
	beqz	$2, $BB85_12
...
$BB86_3:
	...
	nop
	lw	$6, 32($16)                     # 4-byte Folded Reload
	lw	$7, 36($16)                     # 4-byte Folded Reload
	move	$4, $2
	move	$5, $3
	jal	__eqdf2
	nop

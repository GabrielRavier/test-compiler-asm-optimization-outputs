...
.L1164:
		...
		extu	.s1	A19, 16, 16, A23
	||	cmpeq	.l1	0, A22, A18
		cmpeq	.l1	0, A18, A25
	||	mv	.s1	A21, A18
		cmpltu	.l1	A23, A17, A24
		and	.d1	A25, A24, A20
		mv	.d1	A20, A2
	[!A2]	b	.s1	.L1163
	||[A2]	mv	.l2x	A19, B4
	[A2]	extu	.s1	A21, 16, 16, A7
		mv	.l1x	B4, A8
		ext	.s1	A8, 16, 16, A9
		cmpgt	.l1	0, A9, A2
		nop	1
...
.L1168:
	...
	||	mv	.d1	A28, A2
		cmpgtu	.l1	A27, A17, A0
	||[!A2]	b	.s1	.L1166
	[!A0]	or	.d1	A20, A18, A18
	||[!A0]	sub	.l2x	A4, B4, B4
	||	shru	.s1	A19, 2, A29
		shru	.s1	A7, 3, A31
	[!A0]	mv	.l1x	B4, A4
	...
	||	shru	.s1	A19, 3, A3
		...
		cmpgtu	.l1	A29, A30, A1
	||	shru	.s1	A7, 4, A8
	;; condjump to .L1166 occurs
	[!A1]	sub	.d1	A4, A29, A29
	||[!A0]	b	.s1	.L1166
	...
	||	mv	.d1	A25, A1
		cmpgtu	.l1	A23, A24, A2
	||	shru	.s1	A19, 10, A9
	[!A2]	sub	.d1	A4, A23, A23
	||	shru	.s1	A7, 11, A20
		shru	.s1	A19, 11, A17
		nop	1
	;; condjump to .L1166 occurs
	[!A1]	b	.s1	.L1166
	||[!A2]	mv	.d1	A23, A4
	||[!A2]	or	.l1	A18, A22, A18
		extu	.s1	A4, 16, 16, A27
	||	mv	.d1	A28, A2
		cmpgtu	.l1	A26, A27, A0
	||	shru	.s1	A7, 12, A22
	[!A0]	sub	.d1	A4, A26, A26
	||	shru	.s1	A19, 12, A23
		nop	2
	;; condjump to .L1166 occurs
	[!A2]	b	.s1	.L1166
	||[!A0]	mv	.d1	A26, A4
	||[!A0]	or	.l1	A18, A25, A18
		extu	.s1	A4, 16, 16, A30
	||	mv	.d1	A31, A0
		cmpgtu	.l1	A29, A30, A1
	||	shru	.s1	A7, 13, A25
...
.L1163:
		mv	.s1	A22, A0
	||	cmpgtu	.l1	A23, A17, A1
	[!A0]	b	.s1	.L1166
	[!A1]	mvk	.s1	32767, A21
	[A1]	mvk	.s1	32767, A25
	||[!A1]	and	.d1	A21, A7, A20
	[A0]	b	.s1	.L1168
	||[A1]	and	.d1	A25, A7, A20
	||[!A1]	and	.d2x	B4, A21, B4
	[!A1]	extu	.s1	A18, 16, 16, A7
	||[A1]	and	.d2x	B4, A25, B4
	[A1]	extu	.s1	A19, 16, 16, A19
	;; condjump to .L1166 occurs
	[!A1]	sub	.l1	A4, A19, A4
	||[A1]	extu	.s1	A21, 16, 16, A7
	||[A1]	mvk	.d1	0, A18
	[!A1]	extu	.s1	A19, 16, 16, A19
	[!A1]	extu	.s1	A4, 16, 16, A17
	;; jump to .L1168 occurs
.L1209:
		cmpeq	.l1	A17, A5, A0
	[A0]	b	.s1	.L1166
	||[A0]	mvk	.d1	1, A18
...
__powidf2:
	...
	||	mvk	.d1	0, A14
		mvklh	.s1	16368, A15
	;; condjump to .L1288 occurs
.L1290:
		call	.s2	(__c6xabi_mpyd)
	||	dmv	.s1	A15, A14, A5:A4
	||	mv	.l2x	A12, B4
		mv	.l2x	A13, B5
	||	addkpc	.s2	.L1297, B3, 0
